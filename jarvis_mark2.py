...
from google import genai                      # CHANGED: Gemini SDK instead of groq
from google.genai import types                # NEW: config + tool wrapper types
import requests
import json
import subprocess
...
# CHANGED: Gemini client, reading the new key from .env
client = genai.Client(api_key=os.getenv("GEMINI_API_KEY"))

# ---- your functions: UNCHANGED, copied straight from Mark 1 ----
